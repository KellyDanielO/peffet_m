$(document).ready(() => {
    function pcgetNotif() {
        $.ajax({
            ...
            success: (data) => {
                let con = document.querySelector(".notif_bx");
                con.innerHTML = '';
                let arr = [];
                data.forEach(res => {
                    switch (res.type) {
    ...
    var pc_nav_btns = document.querySelectorAll(".pc_nav_btn");
    pc_nav_btns.forEach(pc_nav_btn => {

        pc_nav_btn.addEventListener("click", e => {
            pc_nav_btns.forEach(k => {
                k.classList.remove("active");
            })
            e.target.classList.add("active");
        });
    });
    const post_likes = document.querySelector("#pc_post_likes");
    const all = document.querySelector("#pc_all");
    const mentions = document.querySelector("#pc_mentions");
    const activity = document.querySelector("#pc_activity");
